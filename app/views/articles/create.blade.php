...
<div class="container">
    ...
    <nav class="navbar navbar-inverse">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ URL::to('anasayfa') }}">Laravel Test Projesi</a>
        </div>
        <ul class="nav navbar-nav">
            <li><a href="{{ URL::to('makaleler') }}">Bütün Makaleler</a></li>
            <li><a href="{{ URL::to('makaleler/makale-ekle') }}">Makale Ekle</a>
        </ul>
    </nav>
